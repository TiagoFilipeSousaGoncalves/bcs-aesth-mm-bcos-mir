...
# Function: Decorator to register a function as an entrypoint
def register(
...
# Function: List all available pretrained models
...
# Dictionary: map (base -> (model_name -> url))
