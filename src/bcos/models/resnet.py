...
# Function: 3X3 Convolution for ResNet
def conv3x3(
    in_planes: int,
    out_planes: int,
    stride: int = 1,
...
# Function: 1X1 Convolution for ResNet
def conv1x1(
    in_planes: int,
    out_planes: int,
    stride: int = 1,
...
# Function: General constructor for ResNet
def _resnet(
    arch: str,
    block: Type[Union[BasicBlock, Bottleneck]],
    layers: List[int],
