...
class Experiment:
    ...
    def load_trained_model(
        ...
        **kwargs: Any
        ...
        if (not self.save_dir.exists() or len(self.available_checkpoints(suppress_warnings=True)) == 0):
            if verbose:
            ...
            try:
                ...
                return model if not return_training_ckpt_if_possible else dict(model=model, ckpt=None)
