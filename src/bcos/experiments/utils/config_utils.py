...
def get_configs_and_model_factory(dataset: str, base_network: str) -> Tuple[Dict, Callable[..., torch.nn.Module]]:
    """
    ...
    # print(getattr(configs_module, CONFIGS_VAR_NAME))
    # print(getattr(model_module, MODEL_FACTORY_VAR_NAME))
