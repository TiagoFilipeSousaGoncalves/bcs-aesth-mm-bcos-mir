...
# Project Imports
from bcos.data.presets import ISIC2018ClassificationPresetTrain, ISIC2018ClassificationPresetTest
...
DEFAULTS = dict(
    data=dict(
        train_transform=ISIC2018ClassificationPresetTrain(is_bcos=IS_BCOS),
        test_transform=ISIC2018ClassificationPresetTest(is_bcos=IS_BCOS),
