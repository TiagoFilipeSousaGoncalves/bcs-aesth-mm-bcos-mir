...
# Project Imports
from bcos.data.presets import HerlevClassificationPresetTrain, HerlevClassificationPresetTest
...
DEFAULTS = dict(
    data=dict(
        train_transform=HerlevClassificationPresetTrain(is_bcos=IS_BCOS),
        test_transform=HerlevClassificationPresetTest(is_bcos=IS_BCOS),
