...
# Project Imports
from bcos.data.presets import VinDrCXRClassificationPresetTrain, VinDrCXRClassificationPresetTest
...
DEFAULTS = dict(
    data=dict(
        train_transform=VinDrCXRClassificationPresetTrain(is_bcos=IS_BCOS),
        test_transform=VinDrCXRClassificationPresetTest(is_bcos=IS_BCOS),
