...
# do
#     echo $m
#     DATA_ROOT="/media/TOSHIBA6T/ICRTO/DATASETS/CXR8/" CUDA_VISIBLE_DEVICES=1 python B-cos-v2-main/xai_eval.py --explainer_name $m --weights "./experiments/baseline_densenet121_lr1e-5_aug/CXR8/baseline_densenet121/baseline_densenet121/best.ckpt"
#     # DATA_ROOT="/media/TOSHIBA6T/ICRTO/DATASETS/CXR8/" CUDA_VISIBLE_DEVICES=0 python B-cos-v2-main/interpretability/analyses/localisation.py --reload weights --weights "./experiments/baseline_densenet121_lr1e-5_aug/CXR8/baseline_densenet121/baseline_densenet121/best.ckpt" --analysis_config 20_2x20.5 --explainer_name $m --smooth 15 --batch_size 1 --save_path "./experiments/baseline_densenet121_lr1e-5_aug/CXR8/baseline_densenet121/baseline_densenet121/"
# done
