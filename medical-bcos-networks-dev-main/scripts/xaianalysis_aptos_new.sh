...
do
    ...
    echo "GCam"
    DATA_ROOT="/media/TOSHIBA6T/ICRTO/DATASETS/APTOS2019/" CUDA_VISIBLE_DEVICES=1 python B-cos-v2-main/xai_eval.py --explainer_name "GCam" --weights $b --batch_size 1 --num_workers 8 --imgs_file $IMGS_FILE

    for m in "${METHODS[@]}"
    do
        echo $m
        DATA_ROOT="/media/TOSHIBA6T/ICRTO/DATASETS/APTOS2019/" CUDA_VISIBLE_DEVICES=1 python B-cos-v2-main/xai_eval.py --explainer_name $m --weights $b --batch_size 8 --num_workers 8  --imgs_file $IMGS_FILE
