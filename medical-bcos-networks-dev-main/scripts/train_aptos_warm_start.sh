...
do
    ...
    --wandb_name aptos2019_bcos_densenet121_warm_${p}_new_base \
    --base_directory "new_experiments/bcos_densenet_warm_${p}_new_base" \
    ...
    # --wandb_name aptos2019_bcos_densenet121_warm_${p}_feats_only \
