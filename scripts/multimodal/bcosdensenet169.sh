...
#SBATCH --output=bcosdensenet169.out
#SBATCH --error=bcosdensenet169.err
...
#  --gpu_id 0 \
#  --config_json 'config/multimodal/E/bcosdensenet169.json' \
...
python src/main_multimodal.py \
 ...
 --pickles_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/pickles/E' \
 --img_model_weights_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/results/E/2024-12-18_20-55-34/bin/model_final.pt' \
 --checkpoint_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/results/E/2024-12-23_00-07-35/' \
 --train_or_test 'test' \
 --verbose
echo "Finished"
...
# python src/main_multimodal.py \
#  --gpu_id 0 \
#  --config_json 'config/multimodal/F/bcosdensenet169.json' \
#  --csvs_path '/nas-ctm01/datasets/private/CINDERELLA/breloai-web-db/csvs' \
...
python src/main_multimodal.py \
 ...
 --pickles_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/pickles/F' \
 --img_model_weights_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/results/F/2024-12-20_16-02-46/bin/model_final.pt' \
 --checkpoint_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/results/F/2024-12-23_00-17-02/' \
 --train_or_test 'test' \
 --verbose
echo "Finished"