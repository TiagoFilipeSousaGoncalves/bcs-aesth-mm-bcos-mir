...
python src/main_image.py \
 --gpu_id 0 \
 --config_json 'config/image/E/baseline_densenet201.json' \
...
#  --pickles_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/pickles/E' \
#  --train_or_test 'test' \
#  --checkpoint_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/results/E/2024-11-17_09-55-12/' \
#  --verbose
# echo "Finished"
...
python src/main_image.py \
 --gpu_id 0 \
 --config_json 'config/image/F/baseline_densenet201.json' \
...
#  --pickles_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/pickles/F' \
#  --train_or_test 'test' \
#  --checkpoint_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/results/F/2024-11-17_14-16-35/' \
#  --verbose
# echo "Finished"