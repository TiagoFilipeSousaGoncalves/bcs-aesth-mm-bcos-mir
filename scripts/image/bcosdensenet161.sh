...
#  --gpu_id 0 \
#  --config_json 'config/image/E/bcosdensenet161.json' \
...
python src/main_image.py \
 ...
 --pickles_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/pickles/E' \
 --train_or_test 'test' \
 --checkpoint_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/results/E/2024-12-06_17-59-58/' \
 --verbose
echo "Finished"
...
# python src/main_image.py \
#  --gpu_id 0 \
#  --config_json 'config/image/F/bcosdensenet161.json' \
...
python src/main_image.py \
 ...
 --pickles_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/pickles/F' \
 --train_or_test 'test' \
 --checkpoint_path '/nas-ctm01/datasets/private/CINDERELLA/experiments/retrieval/tgoncalv/results/F/2024-12-08_07-11-12/' \
 --verbose
echo "Finished"